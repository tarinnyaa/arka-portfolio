...
export const ABOUT = {
  ...
  signal: {
    ...
    phones: [
      { key: "myopia", name: "Myopia", outcome: "Your plant grew", status: "live" },
      { key: "healthy", name: "Healthy adult", outcome: "Morning light, 34 min", status: "proposed" },
      { key: "glaucoma", name: "Glaucoma", outcome: "34 min bright light today", status: "proposed" },
      { key: "depression", name: "Depression", outcome: "18 min left in the window", status: "proposed" },
      { key: "stroke", name: "Stroke", outcome: "Morning light. Start.", status: "proposed" },
    ],
    live: "Live study",
  ...
  conclusion: {
    ...
    status: "The myopia study has been live with participants since 2026. The other four configurations are designed and awaiting studies.",
  },
};
